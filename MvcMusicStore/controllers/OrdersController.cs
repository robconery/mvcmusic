    ...
    public class OrdersController : DbController
    {
        ...
        public ActionResult Edit(int id, FormCollection form)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return Json(new { success = true, message = "Order Updated", order = order });
            }
            return Json(new { success = false, message = "This order is invalid", order = order });
        }
        ...
        public ActionResult Delete(int id)
        {
            ...
            {
                return Json(new { success = false, message = "There was an error deleting this order" });
            }
        }
